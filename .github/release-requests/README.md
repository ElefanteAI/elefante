...
1. confirm the marker matches the package version;
2. verify version synchronization and public release notes;
3. create the immutable annotated Git tag at the exact merge commit; and
4. dispatch the existing multi-platform release workflow from that tag.
