# Elefante — Full README Snapshot at v2.2.2

> ⚠️ **ARCHIVED** — Complete README as it existed at v2.2.2. Preserved as a historical snapshot only. For current documentation see [README.md](../../README.md).
...
Elefante exposes **21 tools** and **2 prompts** via MCP. All tool names follow the `elefante-PascalCase` convention.
...
| [`technical/installation.md`](technical/installation.md)                     | Installation details and binary compilation                                                                                                                |
...
| [`technical/safe-restart.md`](technical/safe-restart.md)                     | Graceful restart, lock cleanup, force-kill fallback                                                                                                        |
| [`technical/dashboard-startup.md`](technical/dashboard-startup.md)           | Dashboard startup and verification                                                                                                                         |
| [`technical/dashboard-snapshot-contract.md`](technical/dashboard-snapshot-contract.md) | Snapshot JSON schema for dashboard consumption                                                                                                  |
| [`technical/docker.md`](technical/docker.md)                                 | Docker setup                                                                                                                                               |
| [`technical/agent-handoff.md`](technical/agent-handoff.md)                   | Agent Zero / autonomous agent integration                                                                                                                  |
| [`technical/architecture.md`](technical/architecture.md)                     | System design, triple-layer brain                                                                                                                          |
| [`technical/ingestion-protocol.md`](technical/ingestion-protocol.md)         | 5-step ingestion pipeline (Extract → Classify → Integrity → Write → Reinforce)                                                                            |
| [`technical/developer-etiquette.md`](technical/developer-etiquette.md)       | **SPECIFICATION**: Feature closure discipline (clean, docs, version)                                                                                       |
