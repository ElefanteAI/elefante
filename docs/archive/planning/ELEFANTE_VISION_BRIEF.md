...
| File                               | Purpose              |
| ---------------------------------- | -------------------- |
| `scripts/setup/install.py`               | Unified installation |
| `scripts/pipeline/update_dashboard_data.py` | Snapshot generation  |
| `scripts/verify/verify_health.py`          | System diagnostics   |
| `scripts/lifecycle/reset_factory.py`         | Complete data wipe   |
...
| Dashboard     | Snapshot stale        | Run `python scripts/pipeline/update_dashboard_data.py`      |
...
| Dashboard           | `src/dashboard/server.py`  | `scripts/pipeline/update_dashboard_data.py`                    |
...
4. **Always verify** with `scripts/verify/verify_health.py` after changes
