...
| --- | --- | --- | --- |
| `elefante-MemoryAdd` | Memory lifecycle | Yes | Yes |
| `elefante-MemorySearch` | Routing, compliance reset, memory lifecycle, cleanup | Yes | Yes |
...
| `elefante-MemoryConsolidate` | ETL and consolidation | Yes | Yes |
| `elefante-MemoryUpdate` | Memory lifecycle | Yes | Yes |
| `elefante-MemoryDelete` | Compliance gate, memory lifecycle, cleanup | Yes | Yes |
...
- Delete protocol-created memories through `elefante-MemoryDelete`
...
- The failure already matches a `BUG-NNN` row in `docs/debug/README.md`
...
- **Handshake / inventory / prompts**: inspect `src/mcp/server.py`, `tests/test_developer_routing.py`, and `docs/technical/spec-tools.md`
- **Routing / directives / compliance**: inspect `docs/debug/ops-ai-behavior-compendium.md`
- **Memory / ETL / refinery**: inspect `docs/debug/ops-memory-compendium.md`
- **Graph / sessions / tasks / lock symptoms**: inspect `docs/debug/ops-database-compendium.md`
- **Dashboard opt-in phase**: inspect `docs/debug/ops-dashboard-compendium.md`
