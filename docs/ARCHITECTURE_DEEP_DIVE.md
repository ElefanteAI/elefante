...
1.  **Heuristic Context**: The "Conversation Context" relies on embedding similarity and keyword matching. It lacks a true "working memory" buffer that holds the _current_ state of reasoning.
