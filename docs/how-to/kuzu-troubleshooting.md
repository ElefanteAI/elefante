...
If this fails, the runtime error should route you to `workspace/postmortems/database.md` Issue #2.
...
- [`view-dashboard.md`](view-dashboard.md) — Dashboard startup and verification
- [`restart.md`](restart.md) — Safe restart procedures
- [`architecture.md`](../reference/architecture.md) — Transaction-scoped locking design
