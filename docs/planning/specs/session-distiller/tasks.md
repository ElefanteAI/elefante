...
- [x] **T2.1**: Create `ingester.py` — `ChatSession` → `elefanteMemoryAdd` bridge
- [x] **T2.2**: Raw archive storage (importance=1, high decay, session reference only)
...
- [x] **T3.4**: Implement `store_insights()` — importance=8-10, zero decay
