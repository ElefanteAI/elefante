...
- the debug record in `docs/debug/ops-memory-compendium.md` already documents this false-positive path
...
| `docs/technical/ops-installation.md` | Rewrite shipped install docs after implementation to match the product path |
