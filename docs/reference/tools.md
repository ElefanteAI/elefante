# MCP Tools and Prompts (published v2.15.2 baseline; current source)
...
**Status**: Released and default-on in v2.15.2.
...
- Use `specification` for durable architecture or contract truths. Use
  ...
  Governance fields are part of the v2.15.2 customer contract.
