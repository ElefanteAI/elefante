...
| `verify_dashboard_snapshot.py` | Verifies the snapshot `.json` structural integrity generated by `update_dashboard_data.py` to prevent React rendering crashes. | **High** (Dashboard stability) |
