...
TARGETS = [
    ...
    ("docs/technical/README.md",                      r'(\*\*Version\*\*:\s*)\d+\.\d+\.\d+',                r'\g<1>{v}'),
    ...
    ("docs/technical/developer-etiquette.md",         r'(\*\*Version:\*\*\s*)\d+\.\d+\.\d+',                 r'\g<1>{v}'),
    ...
    ("docs/technical/sdd-development-protocol.md",    r'(\*\*Version\*\*:\s*)\d+\.\d+\.\d+',                 r'\g<1>{v}'),
