...
RELEASE_DOC_TARGETS = [
    ...
    ("docs/how-to/configure-ide.md", r'(?m)^\*\*Applies to:\*\* v[\d.]+$', '**Applies to:** v{v}'),
    ("docs/how-to/agent-handoff.md", r'customers should use the v[\d.]+ platform installer', 'customers should use the v{v} platform installer'),
    ("docs/how-to/agent-handoff.md", r'Download the v[\d.]+ archive', 'Download the v{v} archive'),
    ("docs/how-to/agent-handoff.md", r'https://github\.com/ElefanteAI/elefante/releases/tag/v[\d.]+', 'https://github.com/ElefanteAI/elefante/releases/tag/v{v}'),
