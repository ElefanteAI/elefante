...
| Task Intelligence Pipeline (bounded Task Briefs + controlled outcome evaluation) | [`workspace/proposals/retrieval-effectiveness.md`](../workspace/proposals/retrieval-effectiveness.md) | V2 shadow retrieval is source-grounded and action-gated; historical benchmark is diagnostic-only after acceptance-coupling audit; behavioral golden-path benchmark required before promotion |
