...
| BUG/GAP count tracked | **54 BUG records through BUG-054 + 7 GAPs** | `workspace/ISSUES.md` | Tracked |
...
| Documentation guard | 41 tests pass | `tests/test_developer_routing.py` | Verified 2026-08-28; 61 combined documentation and release-pipeline tests pass |
| Full non-slow regression suite | 674 passed, 4 skipped, 1 deselected; the isolated slow proof passed separately | Exact release-source run on 2026-08-28 | Verified before publication; exact-head and tagged CI passed |
