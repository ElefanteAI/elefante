...
| [test_task_intelligence_evaluation.py](test_task_intelligence_evaluation.py) | Pre-fix source isolation, lineage, file diversity, demo/archive exclusion, paired order, profile isolation, and prompt leakage boundaries | When changing paired evaluation or retrieval audit |
| [test_task_intelligence_report.py](test_task_intelligence_report.py) | Protocol completeness, profile isolation, clustered confidence, resource limits, and behavioral-contract promotion gate | When changing outcome reporting or promotion thresholds |
